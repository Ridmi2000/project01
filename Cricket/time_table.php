...
<div class="container">
 ...
 <h2 style="background-color: darkblue; color: white; padding: 10px;" class="text-center mt-1">Time Table-Cricket</h2>
   <table class="table table-striped table-hover mt-5 table-bordered border-info" id="data_tbl">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM cricket WHERE id LIMIT 7";
   ...
   <table class="table table-striped table-hover mt-5 table-bordered border-info" id="data_tbl">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM cricket WHERE id > 9";
        $result = mysqli_query($conn,$sql);
        while ($row = mysqli_fetch_assoc($result)) {
